...
class IncomesExpensesController extends Controller
{
    ...
    public function storeIncomeExpense(Request $request)
    {
        ...
        //dd($request->all());
        // $del = DB::select('Truncate table  `budget`');
        ...
        if (isset($_POST['income_types'])) {
            ...
            for ($i = 0; $i < ($incomeTypesArr); $i++) {
                ...
                $budget_id = DB::table('budget')->insertGetId([
                    ...
                    'item_value' => ($_POST['income_amounts'][$i] * 12),
        ...
        if (isset($_POST['expense_types'])) {
            ...
            for ($i = 0; $i < ($incomeTypesArr); $i++) {
                ...
                $budget_id = DB::table('budget')->insertGetId([
                    ...
                    'item_value' => ($_POST['expense_amounts'][$i] * 12),
                    'capture_date' => Date::now()
                ]);
                for ($j = 0; $j < 12; $j++) {
                    DB::table('yearly_budget')->insert([
        ...
        if (isset($_POST['income_types_spouse'])) {
            ...
            for ($i = 0; $i < ($incomeTypesArr); $i++) {
                ...
                $budget_id = DB::table('budget')->insertGetId([
                    ...
                    'item_id' => $id,
                    'item_name' => $nameIncome,
                    'item_value' => ($_POST['income_amounts_spouse'][$i] * 12),
                    'capture_date' => Date::now()
                ]);
                for ($j = 0; $j < 12; $j++) {
                    DB::table('yearly_budget')->insert([
        ...
        if (isset($_POST['expense_types_spouse'])) {
            ...
            for ($i = 0; $i < ($incomeTypesArr); $i++) {
                ...
                $budget_id = DB::table('budget')->insertGetId([
                    ...
                    'item_id' => $id,
                    'item_name' => $expenseName,
                    'item_value' => ($_POST['expense_amounts_spouse'][$i] * 12),
                    'capture_date' => Date::now()
                ]);
                for ($j = 0; $j < 12; $j++) {
                    DB::table('yearly_budget')->insert([
    ...
    public function updateIncomeExpense(Request $request)
    {
        ...
        $currentYear = date("Y");
        //income of client
        if (isset($_POST['income_expense_types'])) {
            $incomeTypesArr = count($_POST['income_expense_types']);
            for ($i = 0; $i < ($incomeTypesArr); $i++) {
                $budget_id = DB::table('budget')->insertGetId([
                    'client_reference_id' => $_POST['client_reference_id'],
                    'advisor_id' => $userId,
                    ...
                    'client_type' => $_POST['client_type'],
                    'income_expenses_type' => $_POST['income_expense_types'][$i],
                    'item_type' => $_POST['income_types'][$i],
                    'item_name' => $_POST['income_names'][$i],
                    'item_value' => ($_POST['income_amounts'][$i] * 12),
                    'capture_date' => Date::now()
                ]);
                for ($j = 0; $j < 12; $j++) {
        ...
        if (isset($_POST['expense_types'])) {
            ...
            for ($i = 0; $i < ($incomeTypesArr); $i++) {
                $budget_id = DB::table('budget')->insertGetId([
                    ...
                    'income_expenses_type' => $_POST['income_expense_types_main'][$i],
                    'item_type' => $_POST['expense_types'][$i],
                    'item_name' => $_POST['expense_names'][$i],
                    'item_value' => ($_POST['expense_amounts'][$i] * 12),
                    'capture_date' => Date::now()
                ]);
                for ($j = 0; $j < 12; $j++) {
        ...
        //income of SPOUSE client
        if (isset($_POST['income_expense_types_spouse'])) {
            $incomeTypesArr = count($_POST['income_expense_types_spouse']);
            for ($i = 0; $i < ($incomeTypesArr); $i++) {
                $budget_id = DB::table('budget')->insertGetId([
                    'client_reference_id' => $_POST['client_reference_id'],
                    'advisor_id' => $userId,
                    ...
                    'income_expenses_type' => $_POST['income_expense_types_spouse'][$i],
                    'item_type' => $_POST['income_types_spouse'][$i],
                    'item_name' => $_POST['income_names_spouse'][$i],
                    'item_value' => ($_POST['income_amounts_spouse'][$i] * 12),
                    'capture_date' => Date::now()
                ]);
                for ($j = 0; $j < 12; $j++) {
        ...
        //Expenses of SPOUSE client
        if (isset($_POST['income_expense_types_spouse1'])) {
            $incomeTypesArr = count($_POST['income_expense_types_spouse1']);
            for ($i = 0; $i < ($incomeTypesArr); $i++) {
                $budget_id = DB::table('budget')->insertGetId([
                    'client_reference_id' => $_POST['client_reference_id'],
                    'advisor_id' => $userId,
                    ...
                    'income_expenses_type' => $_POST['income_expense_types_spouse1'][$i],
                    'item_type' => $_POST['expense_types_spouse'][$i],
                    'item_name' => $_POST['expense_names_spouse'][$i],
                    'item_value' => ($_POST['expense_amounts_spouse'][$i] * 12),
                    'capture_date' => Date::now()
                ]);
                for ($j = 0; $j < 12; $j++) {
